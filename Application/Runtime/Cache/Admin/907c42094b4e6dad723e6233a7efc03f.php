...
<div class="modal-body overflow-visible">
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" required="required" id="name" name="name" value="<?php echo ($info["name"]); ?>" placeholder="名称"/>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		<label class="control-label" for="notice_id">公告编号</label>
		<div class="controls">
			<input type="text" required="required" id="notice_id" name="notice_id" value="" placeholder="公告id.."/>
		</div>
	</div>
...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-small btn-primary" onclick="$.edit('<?php echo U('Admin/Link/doEdit');?>', this);">
