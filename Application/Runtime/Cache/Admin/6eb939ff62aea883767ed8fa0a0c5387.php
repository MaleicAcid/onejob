	...
	<h3 class="header blue lighter smaller">
		...
		<div class="row-fluid  dataTables_wrapper">
			<div class="span12" id="m_search_div">
				...
				<input name="name" value="<?php echo ($name); ?>" type="text" id="search_name" class="pull-right" placeholder="用户名"/>
				...
				<tr>
					...
					<td>
						<span data-original-title="<?php echo ($val["name"]); ?>信息" data-rel="popover" class="tooltip-info" data-content="电话：<?php echo ($val["tel"]); ?><br/>邮箱：<?php echo ($val["email"]); ?><br/>公司领域：<b class='orange'><?php echo ($val["trade"]); ?></b><br/>公司网站：<a href='http://<?php echo ($val["web"]); ?>' target='_blank'><?php echo ($val["web"]); ?></a><br/>城市：<?php echo ($val["city"]); ?><br/>规模人数：<?php echo ($val["scale"]); ?><br/>发展阶段：<?php echo ($val["stage"]); ?><br/>公司描述：<?php echo ($val["desc"]); ?><br/>一句话：<?php echo ($val["one_desc"]); ?>">
							...
							<?php endif ?>
							<img src="<?php echo (get_img($val["logo"])); ?>" style="width:45px;height:45px;cursor:pointer;">
						</span>
					</td>
					...
					<td>
						<div class="hidden-phone visible-desktop action-buttons">
							<?php if ($val['is_top'] == 0): ?>
							<a href="javascript:;" class="grey tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="修改置顶" onclick="$.lagou.formShow('<?php echo U('Admin/Company/is_top_edit', array('id'=>$val['id']));?>');">
								<i class="icon-bullhorn bigger-130"></i>
							</a>
							<?php else: ?>
							<a href="javascript:;" class="blue tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="修改置顶" onclick="$.lagou.formShow('<?php echo U('Admin/Company/is_top_edit', array('id'=>$val['id']));?>');">
								<i class="icon-bullhorn bigger-130"></i>
							</a>
							<?php endif ?>
							<?php if ($val['is_hot'] == 0): ?>
							<a href="javascript:;" class="grey tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="设置热门" onclick="$.check('<?php echo U('Admin/Company/allow_hot', array('id'=>$val['id']));?>');">
								<i class="icon-fire bigger-130"></i>
							</a>
							<?php else: ?>
							<a href="javascript:;" class="orange tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="取消热门" onclick="$.check('<?php echo U('Admin/Company/deny_hot', array('id'=>$val['id']));?>');">
								<i class="icon-fire bigger-130"></i>
							</a>
							<?php endif ?>
							<?php if ($val['status'] == 0): ?>
