...
<div class="row-fluid">
	<h3 class="header blue lighter smaller">
		<div class="row-fluid  dataTables_wrapper">
			<div class="span4">
				<button class="btn btn-primary btn-small" onclick="$.lagou.formShow('<?php echo U('Admin/Notice/add_short_notice');?>');" type="button"><i class="icon-plus"></i>添加短消息</button>
				<button class="btn btn-primary btn-small" onclick="$.updateLink('<?php echo U('Admin/Notice/update_short_notice');?>');" type="button"><i class=""></i>推送短消息更新</button>
			</div>
				...
				<tr>
					...
					<td>
						<div class="hidden-phone visible-desktop action-buttons">
							<a href="javascript:;" onclick="$.lagou.formShow('<?php echo U('Admin/Notice/add_short_notice', array('id'=>$value['id']));?>');" class="blue tooltip-info no-hover-underline" data-rel="tooltip" data-original-title="编辑">
								<i class="icon-pencil bigger-130"></i>
							</a>
							<a href="javascript:;" onclick="$.del('<?php echo U('Admin/Notice/delete_short_notice', array('id'=>$value['id']));?>');" class="red tooltip-error no-hover-underline" data-rel="tooltip" data-original-title="删除图片"><i class="icon-trash bigger-130"></i></a>
						</div>
					</td>
				</tr>
			<?php endforeach ?>
