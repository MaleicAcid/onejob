...
<div class="content">
	<div id="stuInfo" class="Info">
		<a id="head-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<img class="headIcon" src="<?php echo ($user_info['head_pic']); ?>"/>
		...
		<a id="nick-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<span><?php echo ($user_info['realname']); ?></span>
				<img src="<?php echo (C("MB_IMG_URL")); ?>icon/right.png"/>
			</span>
		</a>
		...
		<a id="school-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<span><?php echo ($user_info['school']); ?></span>
				<img src="<?php echo (C("MB_IMG_URL")); ?>icon/right.png"/>
			</span>
		</a>
		<a id="special-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<span><?php echo ($user_info['major']); ?></span>
				<img src="<?php echo (C("MB_IMG_URL")); ?>icon/right.png"/>
			</span>
		</a>
		<a id="level-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<span><?php echo ($user_info['edu']); ?></span>
				<img src="<?php echo (C("MB_IMG_URL")); ?>icon/right.png"/>
			</span>
		</a>
		<a id="time-edit" href="javascript:;">
			...
			<span class="rg-icon">
				<span><?php echo ($user_info['entry_year']); ?></span>
				<img src="<?php echo (C("MB_IMG_URL")); ?>icon/right.png"/>
			</span>
		</a>
