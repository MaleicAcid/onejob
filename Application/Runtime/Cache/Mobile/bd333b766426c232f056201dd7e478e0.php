...
<body>
<header>
	<a href="javascript:history.go(-1)"><img src="<?php echo (C("MB_IMG_URL")); ?>icon/Left.png" width="16px" height="16px"></img></a><span>企业登录</span>
</header>
<div class="main-content">
	<img class="login-icon" href="javascript:company_open_qq()" src="<?php echo (C("MB_IMG_URL")); ?>icon/qq.png"/>
	<img class="login-icon" href="javascript:company_open_weixin()" src="<?php echo (C("MB_IMG_URL")); ?>icon/wechat.png"/>
</div>
<footer>
...
<script type="text/javascript">
    function company_open_qq() {
        window.open("<?php echo U('Home/LoginApi/login',array('oauth'=>'qq','identity'=>'company'));?>");
    }
    function company_open_weixin() {
        window.open("<?php echo U('Home/LoginApi/login',array('oauth'=>'weixin','identity'=>'company'));?>");
    }
</script>
<script type="text/javascript">
