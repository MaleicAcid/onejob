...
//	    $this->return_url = "http://".$_SERVER['HTTP_HOST']."/index.php?m=Home&c=LoginApi&a=callback&oauth=qq";
        ...
        if ($identity == 'company') {
            $this->return_url = "https://".$_SERVER['HTTP_HOST'].U('LoginApi/company_callback',array('oauth'=>'qq'));
        }else{
            $this->return_url = "https://".$_SERVER['HTTP_HOST'].U('LoginApi/user_callback',array('oauth'=>'qq'));
        }
