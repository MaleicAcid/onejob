...
class weixin extends \Think\Model\RelationModel{
	...
	public function __construct($config,$identity){
		...
		if ($identity == 'company') {
            $this->return_url = "https://".$_SERVER['HTTP_HOST'].U('LoginApi/company_callback',array('oauth'=>'weixin'));
		}else{
            $this->return_url = "https://".$_SERVER['HTTP_HOST'].U('LoginApi/user_callback',array('oauth'=>'weixin'));
		}
